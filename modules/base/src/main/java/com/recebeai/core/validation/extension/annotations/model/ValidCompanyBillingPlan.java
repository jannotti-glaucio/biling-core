...
import tech.jannotti.billing.core.validation.extension.constraints.model.ValidCompanyBillingPlanConstraint;

@Constraint(validatedBy = { ValidCompanyBillingPlanConstraint.class })
@Target({ FIELD, PARAMETER })
@Retention(RUNTIME)
public @interface ValidCompanyBillingPlan {
