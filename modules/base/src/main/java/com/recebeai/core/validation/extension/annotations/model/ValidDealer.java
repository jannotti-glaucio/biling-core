...
import tech.jannotti.billing.core.validation.extension.constraints.model.ValidDealerConstraint;

@Constraint(validatedBy = { ValidDealerConstraint.class })
@Target({ FIELD, PARAMETER })
@Retention(RUNTIME)
public @interface ValidDealer {
