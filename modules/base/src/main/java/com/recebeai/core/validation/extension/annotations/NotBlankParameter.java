...
import tech.jannotti.billing.core.validation.extension.constraints.NotBlankParameterConstraint;

@Constraint(validatedBy = { NotBlankParameterConstraint.class })
@Target({ FIELD, PARAMETER })
@Retention(RUNTIME)
public @interface NotBlankParameter {
