...
import tech.jannotti.billing.core.validation.extension.constraints.model.ValidDealerBankAccountConstraint;

@Constraint(validatedBy = { ValidDealerBankAccountConstraint.class })
@Target({ FIELD, PARAMETER })
@Retention(RUNTIME)
public @interface ValidDealerBankAccount {
