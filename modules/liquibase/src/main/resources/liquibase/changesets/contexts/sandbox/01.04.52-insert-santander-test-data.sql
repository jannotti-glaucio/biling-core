...
--changeset billing:1.04.52 dbms:postgresql context:sandbox
--comment Insercao dos dados de teste do banco santander pra sandbox
...
INSERT INTO banking_santander.company_bank_account (
  ...
  '/data/billing/banking/santander/billing/cnab400/remittances/send',
  '/data/billing/banking/santander/billing/cnab400/discharges/receive',
  '/data/billing/banking/santander/billing/cnab400/discharges/processed',
  '/data/billing/banking/santander/billing/cnab400/discharges/rejected'
);
