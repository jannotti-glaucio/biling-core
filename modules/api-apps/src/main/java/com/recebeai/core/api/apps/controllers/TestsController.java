...
import tech.jannotti.billing.core.api.apps.controllers.dto.request.invoice.PayInvoiceRestRequest;
...
public class TestsController extends AbstractAppsController {
    ...
    public RestResponseDTO payInvoice(@PathVariable String token, @RequestBody PayInvoiceRestRequest request) {
        ...
        BaseInvoice invoice = invoiceService.get(application.getDealer(), token);
        if (invoice == null)
