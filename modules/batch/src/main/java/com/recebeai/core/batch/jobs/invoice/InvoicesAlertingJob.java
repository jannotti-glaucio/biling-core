...
public class InvoicesAlertingJob extends AbstractJob {

    private LogManager logManager = LogFactory.getManager(InvoicesAlertingJob.class);
    ...
    public void doExecute(JobExecutionContext executionContext) throws JobExecutionException {
        ...
        logManager.logINFO("Executando envio de Alertas de Faturas");
        invoiceBatchService.processAlerts();
        logManager.logINFO("Finalizando envio de Alertas de Faturas");
    }
