...
import tech.jannotti.billing.core.banking.bb.persistence.repository.CNAB400RemittanceDetailRepository;
...
@Service("banking.bb.cnab400ExchangeService")
class CNAB400ExchangeService extends AbstractBankExchangeService {
    ...
    @Transactional
    public void saveRemittanceFileAndUpdateRemittancesStatus(BancoBrasilCNAB400RemittanceFile remittanceFile,
    ...
    @Transactional
    public void saveDischargeFile(BancoBrasilCNAB400DischargeFile dischargeFile) {

        dischargeFileRepository.save(dischargeFile);

        if (dischargeFile.getDetails() != null) {
            for (BancoBrasilCNAB400DischargeDetail dischargeDetail : dischargeFile.getDetails()) {
    ...
    @Transactional
    public void updateDischargeStatus(BancoBrasilCNAB400DischargeDetail dischargeDetail, BankDischargeStatusEnum status,
        LocalDateTime processingDate) {
        dischargeDetailRepository.updateStatusAndProcessingDateById(dischargeDetail.getId(), status, processingDate);
    }

    @Transactional
    public void processRegisteredDischarge(BancoBrasilCNAB400DischargeDetail dischargeDetail,
        BasePaymentBankBillet baseBankBillet, LocalDateTime processingDate) {

        try {
            processBaseRegisteredDischarge(baseBankBillet, processingDate, dischargeDetail.getNossoNumero(),
                dischargeDetail.getNumeroTituloCedente(), dischargeDetail.getValorTarifa());
    ...
    @Transactional
    public void processDeniedDischarge(BancoBrasilCNAB400DischargeDetail dischargeDetail, BasePaymentBankBillet baseBankBillet,
    ...
    @Transactional
    public void processPaidDischarge(BancoBrasilCNAB400DischargeDetail dischargeDetail, BasePaymentBankBillet baseBankBillet,
    ...
    @Transactional
    public void processCancelledDischarge(BancoBrasilCNAB400DischargeDetail dischargeDetail, BasePaymentBankBillet baseBankBillet,
        LocalDateTime processingDate) {
        ...
        try {
            ...
            logManager.logERROR("Ignorando cancelamento pois o boleto nao estah no status esperado [nossoNumero=%s]", e,
                dischargeDetail.getNossoNumero());
            dischargeDetailRepository.updateStatusAndProcessingDateById(dischargeDetail.getId(), BankDischargeStatusEnum.DENIED,
                processingDate);
            return;
    ...
    @Transactional
    public void processPurgeDischarge(BancoBrasilCNAB400DischargeDetail dischargeDetail, BasePaymentBankBillet baseBankBillet,
        LocalDateTime processingDate) {
        ...
        try {
            ...
            logManager.logERROR("Ignorando baixa pois o boleto nao estah no status esperado [nossoNumero=%s]", e,
                dischargeDetail.getNossoNumero());
            dischargeDetailRepository.updateStatusAndProcessingDateById(dischargeDetail.getId(), BankDischargeStatusEnum.DENIED,
                processingDate);
            return;
            ...
            logManager.logERROR("Ignorando baixa pois o boleto foi registrado para baixa automatica [nossoNumero=%s]", e,
                dischargeDetail.getNossoNumero());
            dischargeDetailRepository.updateStatusAndProcessingDateById(dischargeDetail.getId(), BankDischargeStatusEnum.DENIED,
                processingDate);
            return;
