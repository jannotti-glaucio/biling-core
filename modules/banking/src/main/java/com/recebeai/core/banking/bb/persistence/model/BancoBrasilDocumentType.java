...
@DynamicInsert
@DynamicUpdate
@Table(schema = "banking_bb", name = "document_type")
public class BancoBrasilDocumentType extends AbstractModel {
    ...
    @Column(name = "codigo_de_inscricao")
    private Integer codigoDeInscricao;
